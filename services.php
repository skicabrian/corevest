            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="/services.php" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-700 md:ms-2 dark:text-gray-400 dark:hover:text-primary-300">Services</a>
                    </div>
                    </li>
                </ol>
                </nav>
...
<section class="bg-gray-50 dark:bg-gray-800 reveal">
  <div class="max-w-screen-xl px-4 py-16 mx-auto">
    ...
    <div class="grid gap-8 md:grid-cols-2">
      <!-- Card 1 -->
        <article class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-700 reveal" data-reveal-delay="40">
            <div class="flex items-center gap-3 mb-4">
            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary-50 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">
        ...
        <!-- Card 2 -->
        <article class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-700 reveal" data-reveal-delay="80">
            <div class="flex items-center gap-3 mb-4">
            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary-50 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="M3 7h18M3 12h18M3 17h18"/></svg>
            </span>
      ...
      <!-- Card 3 -->
      <article class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-700 reveal" data-reveal-delay="120">
            <div class="flex items-center gap-3 mb-4">
            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary-50 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="M3 7h18M3 12h18M3 17h18"/></svg>
            </span>
        ...
        <!-- Card 4 -->
        <article class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-700 reveal" data-reveal-delay="160">
            <div class="flex items-center gap-3 mb-4">
            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary-50 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="M3 7h18M3 12h18M3 17h18"/></svg>
            </span>
