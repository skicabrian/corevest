            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">About Us</a>
                    </div>
                    </li>
                </ol>
                </nav>
...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7 pl-10">
            ...
            <p class="mb-6 text-base font-normal text-body">CoreVest General Services Ltd is a registered Malawian company dedicated to delivering high-quality general goods and professional 
            ...
            <div class="mb-4 border-b border-default">
                <h1 class="mb-4 text-4xl tracking-tight font-extrabold text-primary-900 dark:text-white">Our Core Values</h1>
            ...
            <div id="default-tab-content">
                ...
                <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="integrity" role="tabpanel" aria-labelledby="integrity-tab">
                    <p class="text-sm text-body">
                       We deliver what we promise.
                    </p>
                </div>

                <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="professionalism" role="tabpanel" aria-labelledby="professionalism-tab">
                    <p class="text-sm text-body">
                        We conduct business with high standards.
                    </p>
                </div>

                <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="reliability" role="tabpanel" aria-labelledby="reliability-tab">
                    <p class="text-sm text-body">
                        We ensure timely delivery and support.
                    </p>
                </div>

                <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="focus" role="tabpanel" aria-labelledby="focus-tab">
                    <p class="text-sm text-body">
                        We tailor solutions to each client’s needs.
                    </p>
                </div>

                <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="efficiency" role="tabpanel" aria-labelledby="efficiency-tab">
                    <p class="text-sm text-body">
